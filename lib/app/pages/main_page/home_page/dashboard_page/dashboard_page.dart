        ...
        appBar: AppBar(
          ...
          title: Container(
            ...
            child: Row(
              children: [
                // back
                MainWidget.menuButton(AppAssets.backSvg, false, Colors.white, Colors.black.withOpacity(.2), () {
                  backRoute();
                }),
                ...
                Row(
                  ...
                  children: [
                    // basket
                    MainWidget.menuButton(AppAssets.basketSvg, userProvider.cartData?.items?.isNotEmpty ?? false,
                        Colors.white, Colors.black.withOpacity(.2), () {
                                        ...
                                        children: [
                                          Container(
                                            constraints: BoxConstraints(
                                                maxWidth: getSize().width * .8, minWidth: getSize().width * .1),
                                            child: Text(
                                    ...
                                    child: Row(
                                      children: [
                                        if (locator<UserProvider>().profile?.roleName != 'user') ...{
                                          ...
                                          dashboardInfoBox(green50, AppAssets.videoSvg,
                                              data?.webinarsCount?.toString() ?? '-', appText.purchasedCourses, () {}),
                                        },
                                        space(0, width: 16),
                                        dashboardInfoBox(orange50, AppAssets.mailSvg,
                                            data?.supportsCount?.toString() ?? '-', appText.supportMessages, () {},
                                            icWidth: 20),
                                        space(0, width: 16),
                                        if (locator<UserProvider>().profile?.roleName != 'user') ...{
                                          dashboardInfoBox(
                                          ...
                                          dashboardInfoBox(blueFE, AppAssets.calendarEmptySvg,
                                              data?.reserveMeetingsCount?.toString() ?? '-', appText.meetings, () {}),
                                        },
                                        space(0, width: 16),
                                        dashboardInfoBox(cyan50, AppAssets.commentsSvg,
                                            data?.commentsCount?.toString() ?? '-', appText.comments, () {},
                                            icWidth: 22),
                                      ],
                                    ),
                                  ),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: PageView(
                              ...
                              children: [
                                FinancialWidget.financialCard(CurrencyUtils.calculator(data?.balance),
                                    appText.accountBalance, '', () {}, AppAssets.walletSvg, green77(),
                                    isBg: true),
                                slideUi(data?.badges?.earned ?? '',
                                    '${appText.nextBadges}: ${data?.badges?.nextBadge ?? ''}', () {},
                                    isProgressBar: true, progressBarValue: data?.badges?.percent?.toString() ?? '0.0'),
                                FinancialWidget.financialCard(data?.totalPoints?.toString() ?? '0',
                                    appText.rewardPoints, '', () {}, AppAssets.giftSvg, yellow29, isBg: true,
                                    onTapBox: () {
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  timeStampToDate(
                                                      (data?.unreadNoticeboards?[index].createdAt ?? 0) * 1000),
                                                  style: style10Regular().copyWith(color: greyA5),
                                                  maxLines: 5,
                                                  overflow: TextOverflow.ellipsis,
                                                ),
  ...
  LineChartData mainData() {
    return LineChartData(
      ...
      maxY: data?.monthlyChart?.data
              ?.reduce((curr, next) => curr.toInt() > next.toInt() ? curr.toInt() : next.toInt())
              .toDouble() ??
          1.0,
